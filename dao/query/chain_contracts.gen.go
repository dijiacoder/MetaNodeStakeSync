...
func newChainContract(db *gorm.DB, opts ...gen.DOOption) chainContract {
	...
	_chainContract.ChainID = field.NewInt32(tableName, "chain_id")
	_chainContract.ContractName = field.NewInt32(tableName, "contract_name")
	_chainContract.ContractAddress = field.NewString(tableName, "contract_address")
...
type chainContract struct {
	...
	ALL             field.Asterisk
	ID              field.Int64
	ChainID         field.Int32  // 链ID (如 1 for Ethereum Mainnet, 11155111 for Sepolia)
	ContractName    field.Int32  // 合约名称标识符
	ContractAddress field.String // 合约地址
	CreatedTxHash   field.String // 创建交易哈希
	Abi             field.String // 合约ABI
...
func (c *chainContract) updateTableName(table string) *chainContract {
	...
	c.ContractName = field.NewInt32(table, "contract_name")
